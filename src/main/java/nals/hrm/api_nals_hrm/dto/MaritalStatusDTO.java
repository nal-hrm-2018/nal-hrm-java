...
public class MaritalStatusDTO {
  ...
  public String getTypeMaritalStatus() {
    switch (this.maritalStatus) {
      case 1:
        this.typeMaritalStatus = "Single";
        break;
      case 2:
        this.typeMaritalStatus = "Married";
        break;
      case 3:
        this.typeMaritalStatus = "Separated";
        break;
      default:
        this.typeMaritalStatus = "Divorced";
    }
  ...
  public void setTypeMaritalStatus(String typeMaritalStatus) {
    switch (this.maritalStatus) {
      case 1:
        typeMaritalStatus = "Single";
        break;
      case 2:
        typeMaritalStatus = "Married";
        break;
      case 3:
        typeMaritalStatus = "Separated";
        break;
      default:
        typeMaritalStatus = "Divorced";
    }
    this.typeMaritalStatus = typeMaritalStatus;
  }
